...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { competition_id: @invitation.competition_id, user_id: @invitation.user_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { competition_id: @invitation.competition_id, user_id: @invitation.user_id } }
